        ...
        <div className="flex items-center justify-between h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            ...
            <Link to="/checkout" className="relative">
              ...
              {cartItems.length > 0 && (
                <span className="absolute -top-2 -right-2 h-5 w-5 flex items-center justify-center bg-blue-500 text-white text-xs rounded-full animate-bounce-in">
                  {cartItems.length}
                </span>
              )}
            </Link>
      ...
      >
        <div className="container mx-auto px-4 py-2">
          <nav className="flex flex-col py-4 space-y-4">
            <Link to="/" className="px-4 py-2 rounded-md hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
              Home
            </Link>
